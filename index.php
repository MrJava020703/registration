...
<body>
    ...
    <section class="container">
      ...
      <form name="myfrm" method="POST" action="submit.php" class="form">
        <div class="input-box">
        ...
        <div class="input-box address">
          ...
          <input type="text" name="Address"placeholder="Enter your street address line 2" required />
          <div class="column">
          ...
          <div class="column">
            ...
            <input type="number" name="code"placeholder="Enter your pin code" required />
          </div>
        </div>
